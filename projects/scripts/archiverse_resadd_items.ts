...
import {
    ...
    PYRAMID_A_L1_DOWN_HASH,
    PYRAMID_A_L1_UP_HASH,
    PYRAMID_A_L2_DOWN_HASH,
    PYRAMID_A_L2_UP_HASH,
    PYRAMID_A_L3_DOWN_HASH,
    PYRAMID_A_L3_UP_HASH,
    PYRAMID_A_L4_DOWN_HASH,
    PYRAMID_A_L4_UP_HASH,
    PYRAMID_A_L5_DOWN_HASH,
    PYRAMID_A_L5_UP_HASH,
    PYRAMID_A_R1_DOWN_HASH,
    PYRAMID_A_R1_UP_HASH,
    PYRAMID_A_R2_DOWN_HASH,
    PYRAMID_A_R2_UP_HASH,
    PYRAMID_A_R3_DOWN_HASH,
    PYRAMID_A_R3_UP_HASH,
    PYRAMID_A_R4_DOWN_HASH,
    PYRAMID_A_R4_UP_HASH,
    PYRAMID_A_R5_DOWN_HASH,
    PYRAMID_A_R5_UP_HASH,
